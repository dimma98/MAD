...
import com.example.myapplication.Adapter.GridViewSuggestAdapter_1;
    ...
    private void initView() {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(getApplicationContext(),"NICE ! This is "+result,Toast.LENGTH_SHORT).show();
                    ...
                    GridViewSuggestAdapter_1 suggestAdapter = new GridViewSuggestAdapter_1(suggestSource,getApplicationContext(), MainActivity_1.this);
                ...
                {
                    Toast.makeText(MainActivity_1.this, "Incorrect!!!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
