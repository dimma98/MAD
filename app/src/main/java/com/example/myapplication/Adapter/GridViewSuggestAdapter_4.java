...
import com.example.myapplication.MainActivity_4;

/**
 * Created by reale on 3/9/2017.
 */

public class GridViewSuggestAdapter_4 extends BaseAdapter {

    private List<String> suggestSource;
    private Context context;
    private MainActivity_4 mainActivity1;

    public GridViewSuggestAdapter_4(List<String> suggestSource, Context context, MainActivity_4 mainActivity1) {
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(String.valueOf(mainActivity1.answer).contains(suggestSource.get(position)))
                        {
                            ...
                            mainActivity1.suggestAdapter = new GridViewSuggestAdapter_4(mainActivity1.suggestSource,context, mainActivity1);
