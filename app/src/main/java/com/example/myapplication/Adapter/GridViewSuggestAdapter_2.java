...
import com.example.myapplication.MainActivity_2;
...
public class GridViewSuggestAdapter_2 extends BaseAdapter {

    private List<String> suggestSource;
    private Context context;
    private MainActivity_2 mainActivity1;

    public GridViewSuggestAdapter_2(List<String> suggestSource, Context context, MainActivity_2 mainActivity1) {
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(String.valueOf(mainActivity1.answer).contains(suggestSource.get(position)))
                        {
                            ...
                            mainActivity1.suggestAdapter = new GridViewSuggestAdapter_2(mainActivity1.suggestSource,context, mainActivity1);
