...
import com.example.myapplication.Adapter.GridViewSuggestAdapter_4;
...
public class MainActivity_4 extends AppCompatActivity {
    ...
    public GridViewSuggestAdapter_4 suggestAdapter;
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(result.equals(correct_answer))
                {
                    ...
                    GridViewSuggestAdapter_4 suggestAdapter = new GridViewSuggestAdapter_4(suggestSource,getApplicationContext(), MainActivity_4.this);
                ...
                {
                    Toast.makeText(MainActivity_4.this, "Incorrect!!!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void setupList() {
        ...
        suggestAdapter = new GridViewSuggestAdapter_4(suggestSource,this,this);
