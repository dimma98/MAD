...
import com.example.myapplication.Adapter.GridViewSuggestAdapter_2;
...
public class MainActivity_2 extends AppCompatActivity {
    ...
    public GridViewSuggestAdapter_2 suggestAdapter;
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(result.equals(correct_answer))
                {
                    ...
                    GridViewSuggestAdapter_2 suggestAdapter = new GridViewSuggestAdapter_2(suggestSource,getApplicationContext(), MainActivity_2.this);
                ...
                {
                    Toast.makeText(MainActivity_2.this, "Incorrect!!!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void setupList() {
        ...
        suggestAdapter = new GridViewSuggestAdapter_2(suggestSource,this,this);
